...
<html>
  ...
  <body>
    ...
    <table class="calendarTable">
      <thead>
        <tr>
          <th colspan="2"><span class="previousDate"> <g:link action="month" params="[id:projectId,year: monthInfos['previousYear'], month: monthInfos['previousMonth']]">&lt;- <g:message code="default.paginate.prev"/></g:link></span>
          </th>
          <th colspan="3"><center>${nameMonth[currentMonth - 1 ]} ${currentYear}</center></th>
          <th colspan="2">
            <span class="nextDate">
        ...
        <tr>
          <th><g:message code="day.1"/></th>
    <th><g:message code="day.2"/></th>
  <th><g:message code="day.3"/></th>
<th><g:message code="day.4"/></th>
<th><g:message code="day.5"/></th>
<th><g:message code="day.6"/></th>
<th><g:message code="day.7"/></th>
</tr>
</thead>
